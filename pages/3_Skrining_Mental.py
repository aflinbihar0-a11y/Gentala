...
with col_id1:
    nama = st.text_input("Nama (Inisial):", key="id_nama")
...
# 🎯 LOGIKA OTOMATIS: Menghitung Umur Pasien Berdasarkan Tanggal Lahir
hari_ini = datetime.date.today()
hitung_umur = (
    hari_ini.year
    - tgl_lahir.year
    - ((hari_ini.month, hari_ini.day) < (tgl_lahir.month, tgl_lahir.day))
)

if hitung_umur < 1:
    selisih_bulan = (
        hari_ini.year - tgl_lahir.year
    ) * 12 + hari_ini.month - tgl_lahir.month
...
if "EPDS" in kategori:
    ...
    epds_6 = st.radio(
        ...
        [
            ...
            "d. Tidak, saya dapat mengatasinya dengan baik seperti biasanya",
        ],
        key="epds_6",
    )
    epds_7 = st.radio(
    ...
    if st.button("Hitung & Simpan Skor EPDS", key="btn_epds"):
        ...
        skor_total = (
            skala_normal[epds_1[0]]
            + skala_normal[epds_2[0]]
            + skala_terbalik[epds_3[0]]
            + skala_normal[epds_4[0]]
            + skala_terbalik[epds_5[0]]
            + skala_terbalik[epds_6[0]]
            + skala_terbalik[epds_7[0]]
            + skala_terbalik[epds_8[0]]
            + skala_terbalik[epds_9[0]]
        ...
        if flag_danger == "Ada":
            st.error(
                "🚨 **ALARM UTAMA KLINIS (IDE CEDERA DIRI):** Pasien mengindikasikan pikiran menyakiti diri sendiri! Tatalaksana psikologis/rujukan darurat wajib berjalan segera!"
            )
...
# =========================================================================
# 3. MODUL KUESIONER ANAK & REMAJA (SDQ) - REVISI AKURAT PROSOSIAL
# =========================================================================
    ...
    tipe_sdq = st.selectbox(
        ...
        [
            "SDQ Anak (Usia 4-10 Tahun / Parent-Report)",
            "SDQ Remaja (Usia 11-17 Tahun / Self-Report)",
        ],
        key="pilih_versi_sdq",
    )
    ...
    if "Remaja" in tipe_sdq:
        ...
        q1 = st.radio(
            "1. Aku berusaha bersikap baik kepada orang lain. Aku peduli dengan perasaan mereka (Pr1):",
            opsi_sdq,
            key="sdq_r1",
        )
        q2 = st.radio(
            "2. Aku gelisah, aku tidak dapat duduk diam untuk waktu lama (H1):",
            opsi_sdq,
            key="sdq_r2",
        )
        q3 = st.radio(
            "3. Aku sering mengeluh sakit kepala, sakit perut atau sakit-sakit lainnya (E1):",
            opsi_sdq,
            key="sdq_r3",
        )
        q4 = st.radio(
            "4. Kalau aku mempunyai mainan, makanan, atau pensil, aku bersedia berbagi dengan orang lain (Pr2):",
            opsi_sdq,
            key="sdq_r4",
        )
        q5 = st.radio(
            "5. Aku menjadi sangat marah dan sering tidak bisa mengendalikan kemarahanku (C1):",
            opsi_sdq,
            key="sdq_r5",
        )
        q6 = st.radio(
            "6. Aku cenderung menyendiri. Aku lebih suka bermain atau menghabiskan waktu seorang diri (P1):",
            opsi_sdq,
            key="sdq_r6",
        )
        q7 = st.radio(
            "7. Aku umumnya bertingkah laku baik dan biasanya melakukan apa yang diminta oleh orang dewasa (C2*):",
            opsi_sdq,
            key="sdq_r7",
        )
        q8 = st.radio(
            "8. Sering kali aku merasa khawatir terhadap banyak hal (E2):",
            opsi_sdq,
            key="sdq_r8",
        )
        q9 = st.radio(
            "9. Aku suka menolong jika ada seseorang yang terluka, kecewa, atau merasa sedih (Pr3):",
            opsi_sdq,
            key="sdq_r9",
        )
        q10 = st.radio(
            "10. Aku terus-menerus bergerak dengan resah atau menggeliat-geliat (H2):",
            opsi_sdq,
            key="sdq_r10",
        )
        q11 = st.radio(
            "11. Aku mempunyai satu atau lebih teman dekat yang sangat baik (P2*):",
            opsi_sdq,
            key="sdq_r11",
        )
        q12 = st.radio(
            "12. Aku sering bertengkar dengan anak-anak lain atau mengintimidasi mereka (C3):",
            opsi_sdq,
            key="sdq_r12",
        )
        q13 = st.radio(
            "13. Aku sering merasa tidak bahagia, sedih, bahkan sampai menangis (E3):",
            opsi_sdq,
            key="sdq_r13",
        )
        q14 = st.radio(
            "14. Pada umumnya, teman-teman sebayaku menyukai diriku (P3*):",
            opsi_sdq,
            key="sdq_r14",
        )
        q15 = st.radio(
            "15. Perhatianku mudah teralih dan aku sulit untuk berkonsentrasi (H3):",
            opsi_sdq,
            key="sdq_r15",
        )
        q16 = st.radio(
            "16. Aku merasa gugup atau sulit berpisah dengan orang tua dalam situasi baru; aku mudah kehilangan rasa percaya diri (E4):",
            opsi_sdq,
            key="sdq_r16",
        )
        q17 = st.radio(
            "17. Aku bersikap manis dan ramah terhadap anak-anak yang usianya lebih muda dariku (Pr4):",
            opsi_sdq,
            key="sdq_r17",
        )
        q18 = st.radio(
            "18. Aku sering dituduh berbohong atau berbuat curang (C4):",
            opsi_sdq,
            key="sdq_r18",
        )
        q19 = st.radio(
            "19. Aku sering diganggu, dipermainkan, diintimidasi, atau diancam oleh anak-anak lain (P4):",
            opsi_sdq,
            key="sdq_r19",
        )
        q20 = st.radio(
            "20. Aku sering menawarkan diri untuk membantu orang lain (orang tua, guru, atau teman-teman) (Pr5):",
            opsi_sdq,
            key="sdq_r20",
        )
        q21 = st.radio(
            "21. Sebelum melakukan sesuatu, aku biasanya berpikir dahulu tentang akibatnya (H4*):",
            opsi_sdq,
            key="sdq_r21",
        )
        q22 = st.radio(
            "22. Aku mengambil barang yang bukan milikku dari rumah, sekolah, atau tempat lain (C5):",
            opsi_sdq,
            key="sdq_r22",
        )
        q23 = st.radio(
            "23. Aku merasa lebih mudah berteman dengan orang dewasa daripada dengan anak-anak sebayaku (P5):",
            opsi_sdq,
            key="sdq_r23",
        )
        q24 = st.radio(
            "24. Banyak hal yang aku takuti, aku mudah menjadi takut (E5):",
            opsi_sdq,
            key="sdq_r24",
        )
        q25 = st.radio(
            "25. Aku memiliki perhatian yang baik terhadap tugas-tugas dan mampu menyelesaikannya hingga selesai (H5*):",
            opsi_sdq,
            key="sdq_r25",
        )
    else:
        ...
        q1 = st.radio(
            "1. Dapat memperdulikan perasaan orang lain (Pr1):",
            opsi_sdq,
            key="sdq_a1",
        )
        q2 = st.radio(
            "2. Gelisah, anak tidak dapat diam untuk waktu lama (H1):",
            opsi_sdq,
            key="sdq_a2",
        )
        q3 = st.radio(
        ...
        q4 = st.radio(
            "4. Kalau anak mempunyai mainan, kesenangan atau pinsil, anak bersedia berbagi dengan anak-anak lain (Pr2):",
            opsi_sdq,
            key="sdq_a4",
        )
        q5 = st.radio(
            "5. Anak sering sulit mengendalikan kemarahannya (C1):",
            opsi_sdq,
            key="sdq_a5",
        )
        q6 = st.radio(
            "6. Cenderung menyendiri, lebih suka bermain dengan seorang diri (P1):",
            opsi_sdq,
            key="sdq_a6",
        )
        q7 = st.radio(
            "7. Umumnya bertingkah laku baik, biasanya melakukan apa yang disuruh oleh orang dewasa (C2*):",
            opsi_sdq,
            key="sdq_a7",
        )
        q8 = st.radio(
        ...
        q9 = st.radio(
            "9. Suka menolong jika seseorang terluka, kecewa atau merasa sakit (Pr3):",
            opsi_sdq,
            key="sdq_a9",
        )
        q10 = st.radio(
        ...
        q12 = st.radio(
            "12. Sering berkelahi dengan anak-anak lain atau mengintimidasi mereka (C3):",
            opsi_sdq,
            key="sdq_a12",
        )
        q13 = st.radio(
        ...
        q16 = st.radio(
            "16. Gugup atau sulit berpisah dengan orang tua/pengasuhnya pada situasi baru, mudah kehilangan rasa percaya diri (E4):",
            opsi_sdq,
            key="sdq_a16",
        )
        q17 = st.radio(
            "17. Bersikap baik terhadap anak-anak yang lebih muda (Pr4):",
            opsi_sdq,
            key="sdq_a17",
        )
        q18 = st.radio(
        ...
        q20 = st.radio(
            "20. Sering menawarkan diri untuk membantu orang lain (orangtua, guru, anak-anak lain) (Pr5):",
            opsi_sdq,
            key="sdq_a20",
        )
        q21 = st.radio(
            "21. Sebelum melakukan sesuatu ia berpikir dahulu tentang akibatnya (H4*):",
            opsi_sdq,
            key="sdq_a21",
        )
        q22 = st.radio(
        ...
        q23 = st.radio(
            "23. Lebih mudah berteman dengan anak-anak lain daripada dengan orang dewasa (P5):",
            opsi_sdq,
            key="sdq_a23",
        )
        q24 = st.radio(
        ...
        q25 = st.radio(
            "25. Memiliki perhatian yang baik terhadap apapun, mampu menyelesaikan tugas atau pekerjaan rumah sampai selesai (H5*):",
            opsi_sdq,
            key="sdq_a25",
        )
    ...
    if st.button("Hitung & Simpan Skor SDQ", key="btn_sdq"):
        ...
        # 1. Klasifikasi Skor Total Kesulitan
        if "Remaja" in tipe_sdq:
            status_mental = (
                "Normal"
                if skor_total <= 15
                else ("Borderline" if skor_total <= 19 else "Abnormal")
            )
        else:
            status_mental = (
                "Normal"
                if skor_total <= 13
                else ("Borderline" if skor_total <= 16 else "Abnormal")
            )

        # 2. Klasifikasi Khusus Subskala Prososial (0-4 Abnormal, 5 Borderline, 6-10 Normal)
        if skor_prososial >= 6:
            status_prososial = "Normal"
        elif skor_prososial == 5:
            status_prososial = "Borderline"
        else:
            status_prososial = "Abnormal"

        # Rekomendasi Klinis Evaluasi Gabungan
        if status_mental == "Normal" and status_prososial == "Normal":
            rekomendasi = "Edukasi kesehatan mental anak & evaluasi rutin."
        elif status_mental == "Borderline" or status_prososial == "Borderline":
            rekomendasi = (
                "Jadwalkan skrining ulang & berikan stimulasi pola asuh/sosialisasi."
            )
        else:
            rekomendasi = (
                "Rujuk ke poli tumbuh kembang anak / psikolog / dokter spesialis."
            )

        detail_sub = f"E:{skor_emosi}, P:{skor_perilaku}, H:{skor_hiper}, S:{skor_sebaya}, Pr:{skor_prososial}"

        # Tampilkan Hasil di UI Streamlit
        st.markdown("### 📊 Hasil Interpretasi")
        col_m1, col_m2 = st.columns(2)

        with col_m1:
            st.metric(
                label="SKOR TOTAL KESULITAN", value=f"{skor_total} / 40"
            )
            if status_mental == "Normal":
                st.success(f"Klasifikasi: **{status_mental}**")
            elif status_mental == "Borderline":
                st.warning(f"Klasifikasi: **{status_mental}**")
            else:
                st.error(f"Klasifikasi: **{status_mental}**")

        with col_m2:
            st.metric(
                label="SKOR PROSOSIAL (KEKUATAN)",
                value=f"{skor_prososial} / 10",
            )
            if status_prososial == "Normal":
                st.info(f"Subskala Kekuatan: **{status_prososial}**")
            elif status_prososial == "Borderline":
                st.warning(f"Subskala Kekuatan: **{status_prososial}**")
            else:
                st.error(f"Subskala Kekuatan: **{status_prososial}**")
        ...
        baris_data_cloud = [
            ...
            skor_total,
            detail_sub,
            f"Kesulitan: {status_mental} | Prososial: {status_prososial}",
            rekomendasi,
            "Anak/Remaja",
            pemeriksa,
            "-",
...
# =========================================================================
    ...
    for i, q in enumerate(pertanyaan_srq):
        jawaban_srq[f"srq_{i+1}"] = st.radio(
            q, ["Tidak (T)", "Ya (Y)"], key=f"srq_q_{i+1}"
        )

    if st.button("Hitung & Simpan Skor SRQ-20", key="btn_srq"):
        skor_total = sum(
            [1 if jawaban_srq[f"srq_{k}"] == "Ya (Y)" else 0 for k in range(1, 21)]
        )
        ide_bunuh_diri = (
            "Ada" if jawaban_srq["srq_17"] == "Ya (Y)" else "Tidak Ada"
        )
        ...
        if ide_bunuh_diri == "Ada":
            st.warning(
                "🚨 **CRITICAL RED FLAG:** Jangan biarkan pasien pulang tanpa pengawasan keluarga atau nakes!"
            )
...
if sudah_submit:
    with st.spinner(
        "Sedang merekam hasil skrining ke database Google Sheets..."
    ):
        try:
            ...
            st.balloons()
            st.success(
                "✅ Seluruh data skrining kesehatan mental berhasil disimpan ke tab 'Sheet_Mental_Health'!"
            )
        except Exception as e:
            st.error(
                f"⚠️ Gagal mengirim data ke Google Sheets. Periksa konfigurasi st.secrets Anda. Error: {e}"
            )
